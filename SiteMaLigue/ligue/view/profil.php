                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item"><i class="fas fa-award"></i> 1 : </li>
                                            <li class="list-group-item"><i class="fas fa-award"></i> 2 : </li>
                                            <li class="list-group-item"><i class="fas fa-award"></i> 3 : </li>
                                        </ul>
                                    </div>
                                </div>                                
                            </div>
